...
| **Machine Learning (GBDT)** | **[Global XGBoost ](https://xgboost.readthedocs.io/)** — Single cross-series model trained on 100% full dataset (55M+ rows), SNAP/price promotion elasticity. |
