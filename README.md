...
- Revenue weighting uses `sales × sell_price` summed over the training period as a WRMSSE weight — a close proxy for, but not identical to, the exact M5 competition weighting methodology.
